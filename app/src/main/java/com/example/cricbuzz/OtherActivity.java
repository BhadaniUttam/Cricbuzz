...
public class OtherActivity extends AppCompatActivity {
    ...
    int GTimgArr[] = {R.drawable.gt_3, R.drawable.gt_4, R.drawable.gt_5, R.drawable.gt_6, R.drawable.gt_7, R.drawable.gt_8, R.drawable.gt_9, R.drawable.gt_10, R.drawable.gt_11, R.drawable.gt_12, R.drawable.gt_13};

    int CSKimgArr[] = {R.drawable.csk, R.drawable.csk_1, R.drawable.csk_2, R.drawable.csk_3, R.drawable.csk_4, R.drawable.csk_5, R.drawable.csk_6, R.drawable.csk_7, R.drawable.csk_8, R.drawable.csk_9, R.drawable.img};
